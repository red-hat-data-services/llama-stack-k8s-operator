...
To modify the pipelines for `llama-stack-k8s-operator` in the `rhoai-3.4-ea.2` release:
...
```bash
git commit -am "Update pipelinerun for llama-stack-k8s-operator (rhoai-3.4-ea.2)"
